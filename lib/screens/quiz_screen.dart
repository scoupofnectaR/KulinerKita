...
class QuizScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final challenges = [
      {'title': 'Tebak Gambar', 'desc': 'Kenali hidangan dari bentuknya.', 'badge': null},
      {'title': 'Asal Daerah', 'desc': 'Hubungkan rasa dengan peta.', 'badge': 'HOT'},
      {'title': 'Filosofi Makanan', 'desc': 'Cerita dibalik resep kuno.', 'badge': 'LVL 5'},
    ];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ...challenges.map((c) => _challengeCard(context, c)),
              const SizedBox(height: 20),
  ...
  Widget _challengeCard(BuildContext context, Map<String, String?> c) =>
      GestureDetector(
